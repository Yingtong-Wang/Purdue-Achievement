...
setwd('C:\\Users\\wangy\\OneDrive\\Desktop\\Linkedin Project Materials')
...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    ...
    div(style = "margin-left: 10px; margin-right: 10px;",
        ...
        numericInput("Glass_thickness", "Glass Thickness (inches):", min = 0.45, max = 0.53, value = 0.48, step = 0.03),
        numericInput("Cut_speed", "Cut Speed (m/min):", min = 0.2, max = 3.3, value = 2.0, step=0.3),
        numericInput("Silicon_Viscosity", "Silicon Viscosity (cP):", min = 7.5, max = 16.3, value = 12,step=0.5),
        sliderInput("Ambient_Temp", "Ambient Temperature (C):", min = 8, max = 25, value = 20),
  ...
  dashboardBody(
    tabItems(
      ...
      tabItem(tabName = "business",
              ...
              p("By reducing the breakage rate, the company expects to save costs associated with material waste and increase overall production efficiency by up to 15%. This improvement is projected to increase sales by 12%"),
      ...
      tabItem(tabName = "prescriptive",
              p("Based on window size, glass thickness, and ambient temperature."),
              fluidRow(
